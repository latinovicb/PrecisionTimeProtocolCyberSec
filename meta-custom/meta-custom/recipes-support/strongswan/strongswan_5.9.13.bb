...
DEPENDS = "flex-native flex bison-native iptables"
...
# workaround
PACKAGECONFIG[forecast] = "--enable-forecast,--enable-forecast,, ${PN}-plugin-forecast"
...
FILES_${PN}-nm = "${libexecdir}/ipsec/charon-nm ${datadir}/dbus-1/system.d/nm-strongswan-service.conf"
FILES_${PN}-nm-dbg = "${libexecdir}/ipsec/.debug/charon-nm"
